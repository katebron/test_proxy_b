/**
 * @file
 * Code for proxy_link_generator.js
 * <!--With many thanks to Washington University St. Louis for the sample code to use for this purpose--> 
 */
 
(function ($, Drupal, drupalSettings, once) {
    Drupal.behaviors.ProxyLinkGenerator = {
